...
YAHOO.macaw.Book = function() {
	...
	this.render = function(divThumbs, divDataTable) {
		...
		YAHOO.util.Event.addListener(divThumbs, "scroll", this.pages.scroll);
		
		// Fire the scrolling event handler to make things happen
		this.pages.scroll();
	...
	this.showSpinner = function(show) {
		if (show) {
			var opts = {
				...
				color: '#06F', // #rgb or #rrggbb or array of colors
